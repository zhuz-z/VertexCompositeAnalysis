...
request_name    = 'VCTree_STARlight_UPCDiPi_UPCReco_KaMass_mc'
channel         = 'CohRhoToPiPi'
request_name    += '_%s' % datetime.now().strftime('%y%m%d_%H%M%S')

input_filelist	= '/afs/cern.ch/user/j/jiazhao/fileList/STARlight/STARLIGHT_5p36TeV_2023Run3_CohRhoDiPi_20240418.txt'
# input_dataset	= ''
