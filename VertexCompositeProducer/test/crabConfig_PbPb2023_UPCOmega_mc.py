...
## User Input ##############################################################################
pset_name       = 'VCTree_PbPb2023_UPCOmega_mc_cfg.py'

request_name    = 'VCTree_STARlight_UPCOmega_KaMass_mc'
channel         = 'CohOmegaToPiPi'
request_name    += '_%s' % datetime.now().strftime('%y%m%d_%H%M%S')

input_filelist	= '/afs/cern.ch/user/j/jiazhao/fileList/STARlight/STARLIGHT_5p36TeV_2023Run3_CohOmegaDiPi_20240709.txt'
# input_dataset	= ''
