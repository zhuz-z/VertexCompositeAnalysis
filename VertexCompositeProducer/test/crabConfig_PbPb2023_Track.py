...
## User Input ##############################################################################
pset_name       = 'VCTree_PbPb2023_Track_cfg.py'

request_name    = 'VCTree_PbPb2023_Track_HIZeroBias0'
channel         = 'CohPhiToKK'
request_name    += '_%s' % datetime.now().strftime('%y%m%d_%H%M%S')

input_filelist	= '/afs/cern.ch/user/j/jiazhao/fileList/HIZeroBias/HIZeroBias0_HIRun2023A_16Jan2024_v1.txt'
